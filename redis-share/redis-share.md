...
* [RDB data format wiki](https://github.com/leonchen83/redis-replicator/wiki/RDB-dump-data-format)
...
那么讲完了动机，我们可以探寻一下Redis-replicator的实现。Redis-replicator的结构如下所示  
![图5](img5.png)  
...
具体的协议格式是一个非严格的AOF格式；第一个AOF是同步命令的回复，第二个AOF命令很特殊，是一个RESP Bulk String，其内包含了RDB格式。其余的AOF就是master的实时命令。了解AOF格式的话请参照[https://redis.io/topics/protocol](https://redis.io/topics/protocol)  
如图所示:  
![图4](img4.png)  
